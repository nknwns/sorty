                    ...
                    <div class="panel">
                        ...
                        <nav class="panel-nav">
                            <ul class="tab tab-block">
                                <li class="tab-item active"><a href="auth.php">Авторизация</a></li>
                                <li class="tab-item"><a href="registration.php">Регистрация</a></li>
                            </ul>
                        </nav>
                        <div class="panel-body">
                            <form action="/functions/auth.php" method="post" class="form">
                                <div class="form-group">
                                    <label class="form-label" for="input-email">Email</label>
                                    <input class="form-input" type="email" name="email" id="input-email" required placeholder="Email">
                                </div>
                                <div class="form-group">
